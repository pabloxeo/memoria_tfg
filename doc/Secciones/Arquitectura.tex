...
\begin{figure}[H]
    \centering
    % \includegraphics[width=0.9\textwidth]{imagenes/diagrama_arquitectura.png}
    \framebox[0.9\textwidth]{
        \parbox{0.85\textwidth}{
            \centering
            \vspace{4cm}
            \textbf{Espacio para el Diagrama de Arquitectura} \\
            \vspace{0.2cm}
            \textit{(Este diagrama debe mostrar las relaciones entre Core, Renderer, Interfaz, Window, Coder, Camera, CameraController y GizmoControls)}
            \vspace{4cm}
        }
    }
